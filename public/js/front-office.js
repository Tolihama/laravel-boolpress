...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateCurrentPage: function updateCurrentPage(newCurrentPage) {
  ...
  methods: {
    getPostDetail: function getPostDetail() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://127.0.0.1:8000/api/posts/".concat(this.$route.params.slug)).then(function (res) {
        return res.data.not_found ? _this.$router.push({
          name: 'not-found'
        }) : _this.post = res.data;
      })["catch"](function (err) {
        return console.log(err);
...
var render = function () {
  ...
  return _c("header", [
    _c(
      ...
      {
        staticClass:
          "container d-flex justify-content-between align-items-center py-4",
      },
      [
        _c(
          "div",
          { staticClass: "title h1 m-0" },
          [
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "cp" }, [
      _c("a", { staticClass: "btn btn-secondary", attrs: { href: "/admin" } }, [
        _vm._v("Vai al CP"),
      ]),
    ])
  },
...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "d-flex align-items-center ml-3 my-4" },
    [
      _c(
        "button",
        {
      ...
      _vm._l(_vm.pageRange, function (i) {
        return _c(
          "button",
          {
            ...
            on: {
              click: function ($event) {
                return _vm.$emit("newCurrentPage", i)
              },
            },
          },
          [_vm._v("\n        " + _vm._s(i) + "\n    ")]
      ...
      _c("div", { staticClass: "items_count" }, [
        _vm._v(
          "\n        Elementi: " + _vm._s(_vm.pagination.total) + "\n    "
        ),
      ]),
    ],
    2
...
var render = function () {
  ...
  return _c("article", { staticClass: "p-3 mb-3" }, [
    _vm.$route.name != "post-detail"
      ? _c(
          "h2",
          { staticClass: "py-3 h3 post-title" },
          [
            _c(
              "router-link",
              {
                attrs: {
                  to: { name: "post-detail", params: { slug: _vm.post.slug } },
                },
              },
      ...
      : _c("h2", { staticClass: "py-3 h3 post-title" }, [
          ...
          [
            ...
            _vm._l(_vm.post.tags, function (tag) {
              return _c(
                "span",
                {
                  key: "post-" + _vm.post.id + "-tag-" + tag.id,
...
var render = function () {
  ...
  return _c(
    ...
    [
      _c(
        "router-link",
        { staticClass: "btn btn-primary h1", attrs: { to: { name: "posts" } } },
        [_vm._v("Vai al blog!")]
      ),
    ],
    1
...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "container", attrs: { id: "post-detail" } },
    [
      _c(
        "router-link",
        {
...
/* harmony import */ var _pages_PostDetail__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/PostDetail */ "./resources/js/pages/PostDetail.vue");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // ROUTES LIST
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/posts/:slug',
    name: 'post-detail',
    component: _pages_PostDetail__WEBPACK_IMPORTED_MODULE_4__["default"]
  }, {
    path: '*',
    name: 'not-found',
...
module.exports = __webpack_require__(/*! C:\Users\tolih\Desktop\Boolean\31-gen-22-1-feb-22\laravel-boolpress\resources\js\front-office.js */"./resources/js/front-office.js");
